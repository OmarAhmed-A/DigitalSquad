...
### Observation space
The observation space is the (x, y) coordinate of the agent. The top left cell is (0, 0). the bottom right cell is (9,9) for the competition mazes (since they are fixed at 10x10 sizes).

### End condition
The attempt/current game is ended when . 
